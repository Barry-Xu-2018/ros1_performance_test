...
public:
  ...
  bool init() {
    ...
    if (msg_size_ == SIZE_4KB) {
      ...
      sub_ = n_.subscribe<bounded_message::TestData4k>("loopback_test", 10, callback);
      ...
      sub_ = n_.subscribe<bounded_message::TestData64k>("loopback_test", 10, callback);
      ...
      sub_ = n_.subscribe<bounded_message::TestData256k>("loopback_test", 10, callback);
      ...
      sub_ = n_.subscribe<bounded_message::TestData2m>("loopback_test", 10, callback);
    } else {
      auto callback = std::bind(&test_sub::download<bounded_message::TestData8mConstPtr>, this, std::placeholders::_1);
      sub_ = n_.subscribe<bounded_message::TestData8m>("loopback_test", 10, callback);
    }
